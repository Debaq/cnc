...
class GCodeGenerator {
    ...
    generate(paths, config, operationType) {
        ...
        // Nota: La cabecera global se maneja en app.js
        // Este generador solo produce comandos de toolpath por elemento
        if (paths.length === 0) {
            lines.push('; ERROR: No paths to process');
            console.warn('⚠️ No paths provided');
        } else {
